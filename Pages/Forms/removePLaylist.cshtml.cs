...
{
    public class removePLaylistModel : PageModel
    {
        [BindProperty]
        ...
        public IActionResult OnPost()
        {
            ...
            //delete
            connection.ConnectionString = connString;
            sqlCommand = "delete from user_playlist where userID = " + ID + " and playlistID = " + playlistID + ";";
            cmd = new MySqlCommand(sqlCommand, connection);
            connection.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
            ...
            sqlCommand = "delete from playlist where UserID = " + ID + " and ID = " + playlistID + ";";
            cmd = new MySqlCommand(sqlCommand, connection);
            connection.Open();
            cmd.ExecuteNonQuery();
            cmd.Dispose();
